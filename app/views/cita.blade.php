...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    ...
    <form class="form-horizontal" action='cita/updatecita' method="POST" id="formuEdit"> 
    <div class="form-group">
    <label class="col-lg-2 control-label">Proxima Cita:</label>
    <div class="col-lg-9">
                                ...
                                <table class="table table-striped table-hover" id="buscadores">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$pacientes->pc}}</td>
                                            <td><span class="label label-info"> {{HTML::link('#Editcita','Agendar Cita', array('class' => 'edit', 'id' => $pacientes->idpaci,'cita_id' => $pacientes->idcita, 'data-toggle' => 'modal', 'title' => $pacientes->nombre) )}}</span></td>
                                            </tr>
                                        @endforeach
