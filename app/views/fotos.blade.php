...
<div class="col-lg-9">
<input class="form-control" type="number" name="anfi"><br/>
</div></div>
...
<div class="modal fade" id="Foto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
<form role="form" action="fotos/updatefoto" method="post" id="formuEdit" enctype="multipart/form-data" >
  <div class="form-group">
                                ...
                                <table class="table table-striped table-hover" id="dataTables-example">
                                    <thead>
                                        ...
                                        @foreach($pacientes as $pacientes)
                                            ...
                                            @endif
                                            <td>{{ $pacientes->mcorporal }} kg.</td>
                                            <td>{{ $pacientes->cagua }} kg.</td>
                                            </tr>
                                        </tr>
                                        @endforeach
                                      </tbody>
