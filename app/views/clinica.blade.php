...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <fieldset><legend><h1>Datos de la Cita</h1></legend>
    <form class="form-horizontal" action='clinica/updatecita' method="POST" id="formuEdit"> 
...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <fieldset><legend><h1>Datos Paciente</h1></legend>
    <form class="form-horizontal" action='clinica/update' method="POST" id="formuEdit"> 
    <div class="form-group">
    <label class="col-lg-2 control-label">Nombre:</label>
    <div class="col-lg-9">  
    ...
    <label class="col-lg-2 control-label">Sexo:</label> 
    <div class="col-lg-9">
    <select class="form-control" name="sexo_edit">
    ...
    <label class="col-lg-2 control-label">Altura:</label> 
    <div class="col-lg-9">
    <input class="form-control" type="numeric" name="alt_edit" required>
    </div></div>
    <div class="form-group">
    <label class="col-lg-2 control-label">Peso:</label> 
    <div class="col-lg-9">
    <input class="form-control" type="numeric" name="peso_edit" required>
    </div></div>
    <div class="form-group">
    <label class="col-lg-2 control-label">Tel:</label>
    <div class="col-lg-9">
                                ...
                                <table class="table table-striped table-hover" id="buscadores">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$pacientes->pc}}</td>
                                            <td><span class="label label-info"> {{HTML::link('#Edit','Editar', array('class' => 'edit', 'id' => $pacientes->idpaci,'cita_id' => $pacientes->idcita, 'data-toggle' => 'modal', 'title' => $pacientes->nombre) )}}</span>
                                            <span class="label label-info"> {{HTML::link('#Editcita','Agendar Cita', array('class' => 'edit2', 'id' => $pacientes->idpaci,'cita_id' => $pacientes->idcita, 'data-toggle' => 'modal', 'title' => $pacientes->nombre) )}}</span>
                                            </td>
                                            </tr>
                                        @endforeach
...
$(document).ready(function() {
  ...
  $('.edit').click(function() {
    ...
    var faction = "<?php echo URL::to('clinica/data'); ?>";
    $.post(faction, { paciente_id:($(this).attr('id')),cita_id:($(this).attr('cita_id'))}, function(json) {
        if (json.success) {          
            ...
            $('#formuEdit input[name="pcita_edit"]').val(json.date);
