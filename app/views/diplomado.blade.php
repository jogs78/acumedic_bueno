  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <fieldset><legend><h1>Datos Alumno</h1></legend>
    <form class="form-horizontal" action='diplomado/agregar' method="POST" id="nuevo"> 
    ...
    <div class="form-group">
    <label class="col-lg-2 control-label">Inscripción:</label>
    <div class="col-lg-9">
    <input class="form-control" type="date" name="inscripcion" value=<?php echo date('Y-m-d') ?>>
    </div></div>
    <div class="form-group">
    <label class="col-lg-2 control-label">Fin Subscripción:</label>
    <div class="col-lg-9">
    <input class="form-control" type="date" name="finsub">
    </div></div>
    <div class="form-group">
...
<div class="form-group">
<label class="col-lg-2 control-label">Diplomado</label>
<div class="col-lg-9">
<select class="selectpicker" name="diplomado" required>
...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
<fieldset><legend><h1>Datos Alumno</h1></legend>
    <form class="form-horizontal" action='diplomado/update' method="POST" id="formuEdit"> 
    <div class="form-group">
    <label class="col-lg-2 control-label">Nombre:</label>
    <div class="col-lg-9">  
    ...
    <label class="col-lg-2 control-label">Correo:</label>
    <div class="col-lg-9">
    <input class="form-control" type="mail" name="mail_edit">
    </div></div>
    <div class="form-group">
    <label class="col-lg-2 control-label">Inscripción:</label>
    <div class="col-lg-9">
    ...
    <div class="form-group">
    <label class="col-lg-2 control-label">Fin de Subscripción:</label>
    <div class="col-lg-9">
    <input class="form-control" type="date" name="finsub_edit">
    </div></div>
    <div class="form-group">
    ...
    <label class="col-lg-2 control-label">Diplomado</label>
    <div class="col-lg-9">
    <select name="diplomado_edit" required class="form-control">
    
    @foreach($diciplinas as $dici)
    <option value="{{$dici->id}}" >{{$dici->nombre}}</option>
    @endforeach
    <option id="diplomado_edit"></option>        
    </select>
    </div></div>    
...
<input type="hidden" name="diplo_id"> 
</fieldset>
</form>  
...
<!-- End Modal -->
            ...
            @endif
                    ...
                    <h1 class="page-header">Alumnos Diplomado</h1>
<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" style="float:right;" id="new">
  Nuevo
</button>
                                ...
                                <table class="table table-striped table-hover" id="buscadores">
                                    <thead>
                                        ...
                                        <tr >
                                            ...
                                            @foreach($diplomado as $diplo)
                                            @if($diplo->id==$pacientes->idDiciplina and $flag==0)

                                            <td>{{$diplo->nombre}}</td>
                                            <td><span class="label label-info"> {{HTML::link('#Edit','Editar', array('class' => 'edit', 'id' => $pacientes->id, 'iddiplo' => $pacientes->iddiplo, 'data-toggle' => 'modal', 'title' => $pacientes->nombre) )}}</span></td>
                                        <?php $flag=1; ?>
                                            @endif
...
$(document).ready(function() {
  $('.edit').click(function() {
    var faction = "<?php echo URL::to('/getdiplomado/data'); ?>";
    $.post(faction, { paciente_id:($(this).attr('id')),diplo_id:($(this).attr('iddiplo')) }, function(json) {
        if (json.success) {          
            
            $('#formuEdit input[name="paciente_id"]').val(json.id);
            $('#formuEdit input[name="diplo_id"]').val(json.diplo);
            ...
            $("#diplomado_edit").attr('selected',true);
            $('#diplomado_edit').val(json.diploid);
            $('#diplomado_edit').attr("label",'Actual: '+json.diploname);
