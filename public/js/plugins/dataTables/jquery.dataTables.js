...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Sin elementos disponibles" )
		{
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="'+classes.sFilterInput+'" placeholder="Escriba Para Buscar"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Sin elementos para mostrar",
